    ...
    return <>
        <div id={url} className="p-12 border-b md:h-screen flex flex-col">
            <div className="my-auto text-center md:text-left">
                ...
                <p className="mb-12">Passionate software developer who enjoys solving problems and building applications!</p>
                <StyledLink href="/resume.pdf" className="mb-12" >
                    Resume (PDF)
                </StyledLink>
                <div className="flex items-center">
                    <IconLink circular className="text-5xl" href="https://www.linkedin.com/in/jason-pyke/" name={{ prefix: "fab", iconName: "linkedin" }} />
                    <IconLink circular className="text-5xl" href="https://github.com/pyke-jason" name={{ prefix: "fab", iconName: "github" }} />
                    <IconLink circular className="text-5xl" href="mailto:pyke.jason1@gmail.com" name={{ prefix: "fas", iconName: "envelope" }} />
                </div>
            </div>
        </div>
    </>
