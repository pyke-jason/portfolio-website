...
export default function BackgroundSection({ data }: PageProps) {
	return (
		<>
				...
				<div className="flex flex-col xl:flex-row gap-16">
					<div className="flex-auto max-w-2xl">
						...
						<p className="relative z-10 mt-8 text-sm text-zinc-600 ">
							Since then, I've been applying my learning and problem solving skills to tackle software development challenges
							in coursework, projects, and my professional career. I've always been fascinated with how math, logic, and
							algorithms have shaped the tech industry, and am excited to see how the industry changes as I finish school and
